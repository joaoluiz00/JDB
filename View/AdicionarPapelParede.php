...
<head>
    ...
    <title>Adicionar Papel de Parede</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="../Assets/style.css">
</head>
<body>
    <div class="container">
        <h1 class="mb-4">Adicionar Novo Papel de Parede</h1>
        <form method="POST" action="../Processamento/ProcessAdmin.php">
            <input type="hidden" name="action" value="add_papelparede">
            <div class="form-group">
                <label for="nome">Nome do Papel de Parede</label>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="imagem" name="imagem" placeholder="ex: fundo_novo.jpg" required>
                </div>
            ...
            <button type="submit" class="btn btn-primary">Adicionar Papel de Parede</button>
